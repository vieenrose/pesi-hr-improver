...
| 請假申請 (Leave Application) | 公出申請 (Business Trip) |
|:---:|:---:|
| ![請假申請](extension/screenshots/leave_application.png) | ![公出申請](extension/screenshots/business_trip_application.png) |
...
### 📝 2. 越用越聰明的「智慧標籤」
*   系統會自動記住您常輸入的 **「事由」** (如：看診、私事處理) 或 **「地點」**。
